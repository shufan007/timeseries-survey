...
class convolution1d(nn.Conv1d):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True):
        super(convolution1d, self).__init__(in_channels,
                                            out_channels,
                                            kernel_size,
                                            stride,
                                            padding,
    ...
    def forward(self, input):
        return super(convolution1d, self).forward(F.pad(input, (self.__padding, 0)))

class _conv_embedding(nn.Module):
    def __init__(self, in_channels, embedding_size, kernel_size, activation_type='tanh'):
        super(_conv_embedding, self).__init__()
        self.convolution = convolution1d(in_channels, embedding_size, kernel_size)
    ...
    def forward(self, input):
        return self.activation_func(self.convolution(input))
