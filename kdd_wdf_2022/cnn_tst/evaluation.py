...
def evaluate(settings):
    ...
    settings["path_to_test_x"] = '../kdd_wdf_gnn/tests/test_x/0001in.csv'
    settings["path_to_test_y"] = '../kdd_wdf_gnn/tests/test_y/0001out.csv'
    ...
    print(predictions.shape, preds.shape, gts.shape)
