...
def forecast(config):
    ...
    if model_type=='pkl':
        ...
        if config["model_name"] == 'GruAtt':
            from gru_att import GruAtt as network
        elif config["model_name"] == 'GruAttModel':
            from wpf_model import GruAttModel as network
        ...
        # print('load PGL4WPFDataset use time: ', (datetime.now() - time) )
