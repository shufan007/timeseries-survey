...
TAR_DIR =  './data/sdwpf_baidukddcup2022_test_toy2/test_y.zip'
PRED_DIR =  './data/sdwpf_baidukddcup2022_test_toy2/test_x.zip'
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_path", type=str, default="kdd_wdf_test5.zip")
    
    args = parser.parse_args()
    args = vars(args)
    
    print(sys.path)
    pkg_path = args["model_path"]
